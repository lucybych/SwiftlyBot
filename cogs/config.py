...
config_commands_dict: dict[str, str] = {
...
emd_commands_dict: dict[str, str] = {
...
giveaway_commands_dict: dict[str, str] = {
...
level_commands_dict: dict[str, str] = {
...
moderation_commands_dict: dict[str, str] = {
    "ab": "Usage: \nPurpose: ",
    "ban": "Usage: \nPurpose: ",
    "banlist": "Usage: \nPurpose: ",
    "bansync": "Usage: \nPurpose: ",
...
reminder_commands_dict: dict[str, str] = {
...
tmc_commands_dict: dict = {}
tnb_commands_dict: dict[str, str] = {
...
utility_commands_dict: dict[str, str] = {
...
voicelink_commands_dict: dict[str, str] = {
...
#Automod configurations 
    ...
    async def automod(self, ctx: commands.Context) -> None:
        ...
        bad_links: list[str] = await finder.find_list(guild_id, self.database.bad_links)
        bad_words: list[str] = await finder.find_list(guild_id, self.database.bad_words)
        _, time_limit = await finder.find_time(ctx.guild, self.database, self.database.time_limit)
        _, min_account_age = await finder.find_time(ctx.guild, self.database, self.database.min_account_age)
        invite_whitelist: list[int] = await finder.find_list(guild_id, self.database.invite_whitelist)
        drama_channel: discord.abc.GuildChannel | discord.Thread = await finder.find_channel(ctx.guild, self.database, self.database.drama_channel)
        warn_threshold: int = await finder.find_int(guild_id, self.database, self.database.warn_threshold)
        _, mentionspam_time = await finder.find_time(ctx.guild, self.database, self.database.mentionspam_time)
        mentionspam_amount: int = await finder.find_int(ctx.guild, self.database, self.database.mentionspam_amount)
        ...
        embed.add_field(name="Account Time Limit:",value=time_limit,inline=False)
        embed.add_field(name="Minimum Account Age:",value=min_account_age,inline=False)
        ...
        embed.add_field(name="Mention Spam Amount and Time:",value=f"{mentionspam_amount} mentions in {mentionspam_time}",inline=False)
        await ctx.send(embed=embed)
    @automod.error
    async def on_automod_error(self, ctx: commands.Context, error) -> None:
    ...
    @automod.command(name="badlinks")
    async def badlinks(self, ctx: commands.Context, link: Optional[str]) -> None:
    ...
    @badlinks.error
    async def on_badlinks_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    @automod.command(name="badwords", aliases=['censor'])
    async def badwords(self, ctx: commands.Context, word: Optional[str]) -> None:
    ...
    @badwords.error
    async def on_badwords_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    @automod.command(name="dramachannel", aliases=['drama'])
    async def dramachannel(self, ctx: commands.Context, channel: Optional[discord.TextChannel]) -> None:
    ...
    @dramachannel.error
    async def on_dramachannel_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    @automod.command(name="invitewhitelist", aliases=['whitelist', 'wl', 'invitewl'])
    @commands.has_permissions(manage_guild=True)
    async def invitewhitelist(self, ctx: commands.Context, guild_id: Optional[int]) -> None:
    ...
    async def on_invitewhitelist_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    @automod.command(name="mentionspam")
    async def mentionspam(self, ctx: commands.Context, amount: Optional[int], time: Optional[str]) -> None:
    ...
    @mentionspam.error
    async def on_mentionspam_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    async def minage(self, ctx: commands.Context, time: Optional[str]) -> None:
    ...
    @minage.error
    async def on_minage_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    @automod.command(name="timelimit")
    async def timelimit(self, ctx: commands.Context, time: Optional[str]) -> None:
    ...
    @timelimit.error
    async def on_timelimit_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    @automod.command(name="warnthreshold", aliases=['threshold'])
    async def warnthreshold(self, ctx: commands.Context, num: Optional[int]) -> None:
    ...
    @warnthreshold.error
    async def on_warnthreshold_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
...
#Giveaway configurations
    ...
    async def giveaway(self, ctx: commands.Context) -> None:
        ...
        giveaway_blacklist: str = await finder.view_ids(ctx.guild, self.database, self.database.giveaway_blacklist)
        giveaway_hosts: str = await finder.view_ids(ctx.guild, self.database, self.database.giveaway_hosts)
        ...
        await ctx.send(embed=embed)
    @giveaway.error
    async def on_giveaway_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    @giveaway.command(name="blacklist", aliases=['bl', 'blist'])
    async def gblacklist(self, ctx: commands.Context, item: Optional[Union[discord.User, discord.Member, discord.Role]]) -> None:
    ...
    @gblacklist.error
    async def on_gblacklist_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    @giveaway.command(name="host")
    async def giveawayhost(self, ctx: commands.Context, item: Optional[Union[discord.User, discord.Member, discord.Role]]) -> None:
    ...
    @giveawayhost.error
    async def on_giveawayhost_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
...
#Level configurations
    @commands.group(invoke_without_command=True)
    @commands.has_permissions(manage_guild=True)
    async def lvlconfig(self, ctx: commands.Context) -> None:
        """Displays the settings for the Level module (Level roles, default level message, level messages, level blacklist)"""
        levels_enabled: bool = await finder.find_bool(ctx.guild, self.database, self.database.levels_enabled)
        default_level_message: str = await finder.find_str(ctx.guild, self.database, self.database.default_level_message)
        level_blacklist: str = await finder.view_ids(ctx.guild, self.database, self.database.level_blacklist)
    ...
    @lvlconfig.command(name="blocks", aliases=['block'])
    async def lvlblocks(self, ctx: commands.Context, item: Optional[Union[discord.Role, discord.User, discord.Member, discord.abc.GuildChannel]]) -> None:
        await config.update_id_list(ctx, self.database, self.database.blocked_messages, item, "list of blocked level up messages")
   
    @lvlconfig.command(name="defaultmessage", aliases=['dmsg', 'defaultmsg', 'dmessage'])
    async def dlevelmsg(self, ctx: commands.Context, *, message: Optional[str]) -> None:
    ...
    @dlevelmsg.error
    async def on_dlevelmsg_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    @lvlconfig.command(name="message", aliases=['msg'])
    async def levelmsg(self, ctx: commands.Context, level: int, *, message: Optional[str]) -> None:
        """Sets the message given by a specific level upon leveling up, or removes the entry for that level if no input is provided"""
        level_messages: dict = await self.database.get_config(ctx.guild.id, self.database.level_messages)
        level_messages = level_messages if level_messages else {}
        if not message:
            ...
            update: UpdateResult = await self.database.update_config(ctx.guild.id, {"$set": {self.database.level_messages: level_messages}})
            await ctx.send(f"Successfully added unique level message for level {level}.") if update.modified_count > 0 else await ctx.send(f"Failed to add unique level message for level {level}.")
    @levelmsg.error
    async def on_levelmsg_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    @lvlconfig.command(name="role")
    async def levelrole(self, ctx: commands.Context, level: int, role: Optional[discord.Role]) -> None:
        """Sets the role given by a specific level, or removes the entry for that level if no input is provided"""
        level_roles: dict = await self.database.get_config(ctx.guild.id, self.database.level_roles)
        ...
        if not role:
            ...
            update: UpdateResult = await self.database.update_config(ctx.guild.id, {"$set": {self.database.level_roles: level_roles}})
            await ctx.send(f"Successfully added unique level role for level {level}.") if update.modified_count > 0 else await ctx.send(f"Failed to add unique level role for level {level}.")     
    @levelrole.error
    async def on_levelrole_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    @lvlconfig.command(name="toggle")
    async def leveltoggle(self, ctx: commands.Context) -> None:
    ...
    @leveltoggle.error
    async def on_leveltoggle_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    @lvlconfig.command(name="blacklist", aliases=['bl', 'blist'])
    async def lvlblacklist(self, ctx: commands.Context, item: Optional[Union[discord.abc.GuildChannel, discord.User, discord.Member, discord.Role]]) -> None:
    ...
    @lvlblacklist.error
    async def on_lvlblacklist_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
...
#Logs configuration
    ...
    async def logs(self, ctx: commands.Context) -> None:
        ...
        server_log: discord.abc.GuildChannel | discord.Thread = await finder.find_channel(ctx.guild, self.database, self.database.server_log)
        join_leave_log: discord.abc.GuildChannel | discord.Thread = await finder.find_channel(ctx.guild, self.database, self.database.join_leave_log)
        member_log: discord.abc.GuildChannel | discord.Thread = await finder.find_channel(ctx.guild, self.database, self.database.member_log)
        message_log: discord.abc.GuildChannel | discord.Thread = await finder.find_channel(ctx.guild, self.database, self.database.message_log)
        voice_log: discord.abc.GuildChannel | discord.Thread = await finder.find_channel(ctx.guild, self.database, self.database.voice_log)
        log_ignores: str = await finder.view_ids(ctx.guild, self.database, self.database.log_ignores)
        ...
        await ctx.send(embed=embed)
    @logs.error
    async def on_logs_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    @logs.command(name="ignored", aliases=['ignore', 'ignores'])
    async def ignored(self, ctx: commands.Context, item: Optional[Union[discord.abc.GuildChannel, discord.Role, discord.User, discord.Member]]) -> None:
    ...
    @ignored.error
    async def on_ignored_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    @logs.command(name="joinleavelog", aliases=['jllog', 'newbielog'])
    async def joinleavelog(self, ctx: commands.Context, channel: Optional[discord.TextChannel]) -> None:
    ...
    @joinleavelog.error
    async def on_joinleavelog_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    @logs.command(name="memberlog", aliases=['memlog'])
    async def memberlog(self, ctx: commands.Context, channel: Optional[discord.TextChannel]) -> None:
    ...
    @memberlog.error
    async def on_memberlog_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
            await ctx.send("Too many arguments provided. Please only include a valid channel.")
        elif isinstance(error, commands.MissingPermissions):
    ...
    @logs.command(name="messagelog", aliases=['meslog'])
    async def messagelog(self, ctx: commands.Context, channel: Optional[discord.TextChannel]) -> None:
    ...
    @messagelog.error
    async def on_messagelog_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
            await ctx.send("Too many arguments provided. Please only include a valid channel.")
        elif isinstance(error, commands.MissingPermissions):
    ...
    @logs.command(name="serverlog", aliases=['slog', 'guildlog'])
    async def serverlog(self, ctx: commands.Context, channel: Optional[discord.TextChannel]) -> None:
    ...
    @serverlog.error
    async def on_serverlog_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
            await ctx.send("Too many arguments provided. Please only include a valid channel.")
        elif isinstance(error, commands.MissingPermissions):
    ...
    @logs.command(name="voicelog", aliases=['vlog', 'vclog'])
    async def voicelog(self, ctx: commands.Context, channel: Optional[discord.TextChannel]) -> None:
    ...
    @voicelog.error
    async def on_voicelog_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
            await ctx.send("Too many arguments provided. Please only include a valid channel.")
        elif isinstance(error, commands.MissingPermissions):
...
#Moderation configuration
    ...
    async def moderation(self, ctx: commands.Context) -> None:
        ...
        ban_limit: int = await finder.find_int(ctx.guild, self.database, self.database.ban_limit)
        mod_log: discord.abc.GuildChannel | discord.Thread = await finder.find_channel(ctx.guild, self.database, self.database.mod_log)
        mute_role: discord.Role = await finder.find_role(ctx.guild, self.database, self.database.mute_role)
        quarantine_role: discord.Role = await finder.find_role(ctx.guild, self.database, self.database.quarantine_role)
        ...
        await ctx.send(embed=embed)
    @moderation.error
    async def on_moderation_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    @moderation.command(name="modlog", aliases=['mlog'])
    async def modlogset(self, ctx: commands.Context, channel: Optional[discord.TextChannel]) -> None:
    ...
    @modlogset.error
    async def on_modlogset_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    @moderation.command(name="muterole", aliases=['mrole'])
    ...
    @muterole.error
    async def on_muterole_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    @moderation.command(name="quarantinerole", aliases=['qrole'])
    async def quarantinerole(self, ctx: commands.Context, role: Optional[discord.Role]) -> None:
    ...
    async def on_quarantinerole_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
...
#Roles configuration
    ...
    async def roles(self, ctx: commands.Context) -> None:
        ...
        stickyroles: bool = "Enabled" if await finder.find_bool(ctx.guild, self.database, self.database.stickyroles) else "Disabled"
        sticky_blacklist: str = await finder.view_ids(ctx.guild, self.database, self.database.sticky_blacklist)
        embed = discord.Embed(color=discord.Color.dark_gray(),title="Roles Configuration")
        embed.add_field(name="Stickyroles",value=stickyroles,inline=False)
        embed.add_field(name="Sticky Blacklist:",value=sticky_blacklist,inline=False)
        await ctx.send(embed=embed)
    @roles.error
    async def on_rolesconfig_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    @roles.command(name="stickyblacklist", aliases=['sblacklist', 'sbl', 'stickybl'])
    async def stickyblacklist(self, ctx: commands.Context, role: Optional[discord.Role]) -> None:
    ...
    async def on_stickyblacklist_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    @roles.command(name="stickyrole", aliases=['sr', 'sticky'])
    async def stickyrole(self, ctx: commands.Context) -> None:
    ...
    @stickyrole.error
    async def on_stickyrole_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
...
#Starboard configuration
    ...
    async def defaultemote(self, ctx: commands.Context, emoji: Union[discord.Emoji, str] = "⭐") -> discord.Message | None:
        ...
        if emoji and isinstance(emoji, discord.Emoji):
            if emoji.guild.id != ctx.guild.id:
                return await ctx.send("Emote not available in the server.")
            emote_id: int = emoji.id
        elif emoji and isinstance(emoji, str):
            emote_id: str = emoji
        else:
            emote_id = None
        if not emoji:
            update: UpdateResult = await self.database.update_config(ctx.guild.id, {"$set": {self.database.default_emote: "⭐"}})
            await ctx.send(f"Successfully reverted to the default starboard emote.") if update.modified_count > 0 else await ctx.send(f"Failed to revert to the default starboard emote. (Is it already set to the default?)") 
        else:
            update = await self.database.update_config(ctx.guild.id, {"$set": {self.database.default_emote: emote_id}})
            await ctx.send(f"Successfully set {str(emoji)} as the default starboard emote.") if update.modified_count > 0 else await ctx.send(f"Failed to set this emoji as the default starboard emote (Is it already set to this emote?).")
    @defaultemote.error
    async def on_defaultemote_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    async def on_starboardblacklist_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    async def on_starboard_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
    ...
    @starthreshold.error
    async def on_starthreshold_error(self, ctx: commands.Context, error) -> None:
        if isinstance(error, commands.TooManyArguments):
...
#Welcome configuration
    ...
    async def welcome(self, ctx: commands.Context) -> None:
        ...
        welcome_channel: discord.abc.GuildChannel | discord.Thread = await finder.find_channel(ctx.guild, self.database, self.database.welcome_channel)
        join_message: str = await finder.find_str(ctx.guild, self.database, self.database.join_message)
        leave_message: str = await finder.find_str(ctx.guild, self.database, self.database.leave_message)
        ban_message: str = await finder.find_str(ctx.guild, self.database, self.database.ban_message)
    ...
    @commands.command()
    @commands.has_permissions(manage_guild=True)
    async def chelp(self, ctx: commands.Context, command: str) -> None:
